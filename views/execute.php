...
<dl class="uk-description-list uk-description-list-divider" style="margin-bottom: 50px;">
	...
	<dt>
		<a style="display: flex; align-items: center; text-decoration: none;" class="label"
			href="<?= wire('config')->urls->admin ?>setup/logs/view/<?= AppApi::logAccess; ?>/">
			<i style="margin-right: 10px; text-decoration: none;"
				class="fa fa-2x fa-fw fa-code ui-priority-secondary"></i>
			<?= $this->_('Access-Log'); ?>
		</a>
	</dt>
	...
	<dt>
		<a style="display: flex; align-items: center; text-decoration: none;" class="label"
			href="<?= wire('config')->urls->admin ?>setup/logs/view/<?= AppApi::logExceptions; ?>/">
			<i style="margin-right: 10px; text-decoration: none;"
				class="fa fa-2x fa-fw fa-code ui-priority-secondary"></i>
